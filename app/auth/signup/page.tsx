    ...
    <div className="min-h-screen bg-gradient-to-br from-pastel-pink-50 via-pastel-rose-50 to-pastel-pink-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-pastel-pink-700">Join us and enjoy delicious cookies delivered to your door</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-3xl shadow-xl border-2 border-pastel-pink-200">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-pastel-pink-600">
            ...
            <div className="flex items-center">
              ...
              />
              <Label htmlFor="agree-terms" className="ml-2 text-sm text-pastel-pink-700">
                I agree to the{" "}
                <Link href="/terms-of-service" className="font-medium text-pastel-pink-600 hover:text-pastel-pink-800">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link href="/privacy-policy" className="font-medium text-pastel-pink-600 hover:text-pastel-pink-800">
                  Privacy Policy
                </Link>
              </Label>
            </div>
            ...
            <Button
              type="submit"
              disabled={!agreeTerms}
              className="w-full bg-gradient-to-r from-pastel-pink-500 to-pastel-rose-500 hover:from-pastel-pink-600 hover:to-pastel-rose-600 rounded-full py-6 text-lg font-semibold disabled:opacity-50"
            >
              Create account
            </Button>
          </form>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-pastel-pink-700">Or sign up with</span>
              </div>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-pastel-pink-700">
              ...
              <Link href="/auth/login" className="font-medium text-pastel-pink-600 hover:text-pastel-pink-800">
                Sign in
              </Link>
            </p>
          </div>
